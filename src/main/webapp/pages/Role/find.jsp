                    ...
                    <div style="width:800px;height: 400px;margin:0 auto;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                <tr>
                                    <th>序号</th><th>角色名</th><th>角色代码</th><th>角色描述</th><th>操作</th>
                                </tr>
                                <c:forEach items="${roles}" var="role" varStatus="status">
                                    <tr>
                                        ...
                                        <td>${role.comment}</td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/role/update?rid=${role.rid}" class="btn btn-xs default"><i class="fa fa-pencil"></i> 修改</a>
                                            <a href="javascript:if(confirm('确定删除吗？')){location='${pageContext.request.contextPath}/role/delete?rid=${role.rid}'}"  class="btn btn-xs btn-danger del-class"><i class="fa fa-trash-o"></i> 删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
