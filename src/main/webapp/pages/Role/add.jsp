                                ...
                                <div class="form-body form-horizontal">
                                    <form action="/role/add" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type=text" name="name" class="form-control" id="inputEmail1" placeholder="请输入角色名" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputRcode" class="col-sm-3 control-label">角色代码</label>
                                            <div class="col-sm-9">
                                                <input type=text" name="rcode" class="form-control" id="inputRcode" placeholder="请输入角色名" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputComment" class="col-sm-3 control-label">角色备注</label>
                                            <div class="col-sm-9">
                                                <input type=text" name="comment" class="form-control" id="inputComment" placeholder="请输入角色名" required="required">
                                            </div>
                                        </div>
                                        <div class="portlet-title">
                                            <div class="caption">
                                        ...
                                        <div class="form-actions right1">
                                            ...
                                            <label class="col-md-3 control-label">专业管理：</label>
                                                <div class="col-md-9">
                                                    <input type="checkbox" name="permission[]" value="major:menu"  />管理
                                                    <input type="checkbox" name="permission[]" value="major:add"  />增加
                                                    <input type="checkbox" name="permission[]" value="major:find"  />查询
                                                    <input type="checkbox" name="permission[]" value="major:delete"  />删除
                                                    <input type="checkbox" name="permission[]" value="major:update"  />修改
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">班级管理：</label>
                                                <div class="col-md-9">
                                                    <input type="checkbox" name="permission[]" value="class:menu"  />管理
                                                    <input type="checkbox" name="permission[]" value="class:add"  />增加
                                                    <input type="checkbox" name="permission[]" value="class:find"  />查询
                                                    <input type="checkbox" name="permission[]" value="class:delete"  />删除
                                                    <input type="checkbox" name="permission[]" value="class:update"  />修改
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">学生管理：</label>
                                                <div class="col-md-9">
                                                    <input type="checkbox" name="permission[]" value="student:menu"  />管理
                                                    <input type="checkbox" name="permission[]" value="student:add"  />增加
                                                    <input type="checkbox" name="permission[]" value="student:find"  />查询
                                                    <input type="checkbox" name="permission[]" value="student:delete"  />删除
                                                    <input type="checkbox" name="permission[]" value="student:update"  />修改
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">宿舍管理：</label>
                                                <div class="col-md-9">
                                                    <input type="checkbox" name="permission[]" value="dorm:menu"  />管理
                                                    <input type="checkbox" name="permission[]" value="dorm:add"  />增加
                                                    <input type="checkbox" name="permission[]" value="dorm:find"  />查询
                                                    <input type="checkbox" name="permission[]" value="dorm:delete"  />删除
                                                    <input type="checkbox" name="permission[]" value="drom:update"  />修改
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">角色管理：</label>
                                                <div class="col-md-9">
                                                    <input type="checkbox" name="permission[]" value="role:menu"  />管理
                                                    <input type="checkbox" name="permission[]" value="role:add"  />增加
                                                    <input type="checkbox" name="permission[]" value="role:find"  />查询
                                                    <input type="checkbox" name="permission[]" value="role:delete"  />删除
                                                    <input type="checkbox" name="permission[]" value="role:update"  />修改
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">用户管理：</label>
                                                <div class="col-md-9">
                                                    <input type="checkbox" name="permission[]" value="user:menu"  />管理
                                                    <input type="checkbox" name="permission[]" value="user:add"  />增加
                                                    <input type="checkbox" name="permission[]" value="user:find"  />查询
                                                    <input type="checkbox" name="permission[]" value="user:delete"  />删除
                                                    <input type="checkbox" name="permission[]" value="user:update"  />修改
                                                </div>
                                            </div>
                                        </div>
