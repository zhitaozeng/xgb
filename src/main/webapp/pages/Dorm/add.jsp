            ...
            <div class="rows">
                ...
                <div class="row">
                    <div class="portlet-body">
                        <form id="stu_form" action="/dorm/add" class="form-horizontal" method="POST" enctype="multipart/form-data"  style="width:400px;margin:0 auto" role="form">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">楼栋名：</label>
                                    <div class="col-md-8">
                                        <input  type="text" name="name" id="name" class="form-control" required="required" placeholder="请输入楼栋名">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">备注:</label>
                                    <div class="col-md-8">
                                        <input  type="text" name="note" id="note" class="form-control" required="required" placeholder="请输入备注">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">导入房间:</label>
                                    <div class="col-md-8">
                                        <input type="file" id="file_stu" name="file_name" class="form-control" value="选择文件" placeholder=""/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <a target="_blank" href="/dorm/download" class="btn blue"  >下载模板</a>
                                    </div>
                                </div>
                            </div>
