                            ...
                            <div class="portlet-body form">
                                <div class="form-body form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input  id="num" name="num" readonly="readonly" type="text"  class="form-control" value="${student.num}" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">姓名：</label>
                                        <div class="col-md-9">
                                            <input  id="name" name="name" type="text" required="required" class="form-control" value="${student.name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select id="sex" name="sex" class="form-control">
                                                <option value="男" <c:if test="${student.sex.equals('男')}">selected="selected"</c:if> >男</option>
                                                <option value="女" <c:if test="${student.sex.equals('女')}">selected="selected"</c:if> >女</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input  id="idcard" name="idcard" type="text" class="form-control" required="required" placeholder="请输入身份证" value="${student.idcard}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">政治面貌：</label>
                                        <div class="col-md-9">
                                            <input  id="politicalstatus" name="politicalstatus" type="text" class="form-control" placeholder="请输入政治面貌" value="${student.politicalstatus}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">QQ号：</label>
                                        <div class="col-md-9">
                                            <input  id="qq" name="qq" type="text" class="form-control" placeholder="请输入qq号" value="${student.qq}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">家庭地址：</label>
                                        <div class="col-md-9">
                                            <input  id="address" name="address" type="text" class="form-control" placeholder="请输入家庭地址" value="${student.address}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">手机号码：</label>
                                        <div class="col-md-9">
                                            <input  id="selfphone" name="selfphone" type="text" class="form-control" placeholder="请输入手机号码" value="${student.selfphone}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">家庭号码：</label>
                                        <div class="col-md-9">
                                            <input  id="relativephone" name="relativephone" type="text" class="form-control" placeholder="请输入号码" value="${student.relativephone}">
                                        </div>
                                    </div>
                                </div>
                                <div class="clear"></div>
