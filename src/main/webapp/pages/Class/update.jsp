                            ...
                            <div class="portlet-body form">
                                <div class="form-body form-horizontal">
                                    <form action="/class/update" method="post">
                                        <input type="text" name="id" hidden="hidden" value="${c.id}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select  id="major_id" name="major" class=" form-control" data-placeholder="" tabindex="1">
                                                ...
                                                <option  value="${major.id}" <c:if test="${c.major.equals(major.id) }">selected="selected"</c:if> >${major.name}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input  type="text" name="name" id="class_num" class="form-control" value="${c.name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">班级群号：</label>
                                        <div class="col-md-9">
                                            <input value="${c.qqgroup}" id="qq" name="qqgroup" type="text" class="form-control" placeholder="请输入QQ群号">
                                        </div>
                                    </div>
                                </div>
                                <div class="clear"></div>
