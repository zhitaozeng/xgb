                                ...
                                <div class="form-body form-horizontal">
                                    <form action="/major/add" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type=text" name="name" class="form-control" id="inputEmail1" placeholder="请输入专业名" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <select id="major_schsys"  name="schoolsystem" class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                    ...
                                                    <option value="4年" selected="selected">4年</option>
