                            ...
                            <div class="portlet-body form">
                                <div class="form-body form-horizontal">
                                    <form action="/user/update" method="post">
                                        <input type="text" name="uid" hidden="hidden" value="${user.uid}">
                                        <div class="form-group">
                                            <label for="inputEmail1" class="col-sm-3 control-label">用户名</label>
                                            <div class="col-sm-9">
                                                <input type=text" name="username" class="form-control" id="inputEmail1"  required="required" value="${user.username}" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputRcode" class="col-sm-3 control-label">用户密码</label>
                                            <div class="col-sm-9">
                                                <input type=password" name="password" class="form-control" id="inputRcode"  required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail1" class="col-sm-3 control-label">请选择角色</label>
                                            <div class="col-sm-9">
                                                <select name="role" id="role">
                                                    <c:forEach items="${roles}" var="role">
                                                        <option value="${role.rid}" <c:if test="${user.moRole.rid == role.rid}">selected="selected" </c:if> >${role.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
